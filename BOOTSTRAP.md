...
set -- \
  ...
  "bun:runs the seat adapter, reviewer/verifier dispatchers and floor (seats/adapter.ts, verify.ts, walk.ts, floor.ts) -- without it seats cannot be spawned or dispatched:brew install oven-sh/bun/bun   # or see https://bun.sh" \
